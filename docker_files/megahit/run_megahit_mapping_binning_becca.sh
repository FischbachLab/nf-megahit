...
LOCAL=/scratch/users/xdmeng/workdir2
DEFAULT=20
...
MYOUTPUTPATH=/scratch/users/xdmeng/Becca/Analysis/${sample}
...
cp /scratch/groups/kchuang/capsule/allSubj_humanFiltered/${sample}-filtered.1.fastq.gz ${QC_FASTQ}/read1.fastq.gz
cp /scratch/groups/kchuang/capsule/allSubj_humanFiltered/${sample}-filtered.2.fastq.gz ${QC_FASTQ}/read2.fastq.gz
